  ...
  return (
    <div>
      ...
      <p>
        ...
        Utilizes Jetpack Compose, Retrofit, ViewModel and LiveData libraries.
        Uses MVVM architecture (Model-View-ViewModel).<br></br>
      ...
      <p>
        ...
        Enter a sudoku puzzle character that is displayed in a two-dimensional
        array.<br></br>
        Language used: C++
      </p>
      <hr></hr>
